...
| SLM Composition | `docs/rfcs/005-slm-composition.md` | `experiments/exp-slm-composition/` | **Phase 3 DONE** — CLM composition runtime (31 tests). Gates C-G1 100%, C-G2 100%. 3-stage CLM 100% (2 real SLMs). B-1 v2: 96.7% novel TS, 100% JSON Schema. Bootstrap flywheel: KPI Checker SLM (PRD 049) bootstrapped in 45 min. B-2 Causal Validator training. |
