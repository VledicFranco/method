/**
 * PRD 024 (MG-7): LLM Provider Port Interface
 *
 * Lifted from domains/strategies/llm-provider.ts to ports/ so that
 * sessions/print-session.ts can depend on the port rather than importing
 * across domain boundaries.
 *
 * The concrete implementation (ClaudeCodeProvider) stays in strategies/.
 */
