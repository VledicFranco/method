 ...
 *
 * PRD-057 / S2 §4: The port interfaces moved to `@method/runtime/ports`.
 ...
 * is stable.
 *
 * New bridge code should import from `@method/runtime/ports`. Existing
...
import type { RuntimeEvent, RuntimeEventInput } from '@method/runtime/ports';
