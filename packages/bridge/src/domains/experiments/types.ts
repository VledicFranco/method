/**
 * Experiments domain — type definitions (PRD 041 Phase 2).
 *
 * Types for the Cognitive Experiment Lab: experiments, runs, conditions,
 * metrics, and trace records.
 */
 ...
 * creating runs. Each condition specifies the full composition of modules,
 * provider, workspace, and cycle config.
 */
...
/**
 * A run represents one execution of a condition × task pair within an experiment.
 * One experiment typically has many runs (n conditions × m tasks × k repetitions).
 */
 ...
 *
 * This is a view type — the actual events are BridgeEvents. Traces are
 * a filtered + structured projection of BridgeEvents with domain='cognitive'.
 */
...
/**
 * Optional filter for readTraces().
