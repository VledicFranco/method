 ...
 *
 * Re-export from @methodts/methodts canonical parser. All parsing, validation,
...
export type { StrategyGateDecl as StrategyGate } from '@methodts/methodts/strategy/dag-types.js';
 ...
 * Retained for API compatibility — parsing is fully delegated to @methodts/methodts.
 */
...
/** Parse a raw YAML string into a StrategyDAG. Delegates to @methodts/methodts. */
export const parseStrategyYaml = methodtsParseYaml;

/** Parse a pre-parsed YAML object into a StrategyDAG. Delegates to @methodts/methodts. */
export const parseStrategyObject = methodtsParseObject;

/** Validate a StrategyDAG for correctness. Delegates to @methodts/methodts. */
export const validateStrategyDAG = methodtsValidateDAG;

/** Compute topological ordering grouped by levels. Delegates to @methodts/methodts. */
