...
| 39 | [fca-index: MCP Context Tools](39-fca-index-mcp-tools.md) | fca-index/mcp | Agent operators | Using context_query, context_detail, and coverage_check — bundled in @methodts/mcp or standalone via fca-index-mcp |
