...
| Government Component | Existing System Component | Integration |
|---------------------|--------------------------|-------------|
| Legislative process (bill lifecycle) | P3-GOV (RFC lifecycle) | P3-GOV becomes the core legislative pipeline; extended with bicameral stages |
| Parliamentary debate | P1-EXEC M1-COUNCIL | M1-COUNCIL is the debate engine for all parliamentary sessions |
| Executive commissions | /commission skill + M4-HANDOFF | /commission becomes an executive function; M4-HANDOFF produces commissions |
| Judicial audit | M4-DDAG (drift detection) | Drift audits become a judicial power |
| Agent session management | Bridge (PTY pool, channels) | Government sessions spawned via bridge; visibility via channels |
| Automated workflows | Strategy Pipelines (PRD 017) | Strategy DAGs execute government commissions |
| Steering council | Technical Senate | The current steering council becomes the Technical Senate |
| Theory council | Senate Theory seat + COM-THEORY | Theory council provides expertise to the Senate and Theory Committee |
| Council TEAM.yaml | Parliament membership rolls | Persistent membership is extended from council to full government |
| Council AGENDA.yaml | Parliamentary agenda | The agenda system is extended with committee structure and bill tracking |
| Council LOG.yaml | Parliamentary record + judicial opinions | The log system is extended to cover all governmental proceedings |
| /review-advisors | Committee review process | Advisor selection becomes committee-routed review |
| /review-synthesizers | Senate review + judicial review | Synthesis becomes multi-stage review across chambers |
| project-card.yaml | The Constitution + government config | The project card's essence becomes constitutionally protected |
